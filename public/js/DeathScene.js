var DeathScene = function(game,music){
    ...
    var quotes = [ '"Mess with best, die like the rest."','"Time To Die"','"If this were a virus, you\'d be dead now."','"You didn\'t live, but then again, who does"','"You have no chance to survive make your time"','"Life and death come and go like marionettes dancing on a table."'];
