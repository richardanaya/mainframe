...
CharacterSelectScene.prototype.update = function(delta){
    ...
    if(this.character == 0){
        ...
        text = "Street Samurai - A mysterious warrior experienced in martial combat.  Highest strength, defense, and passive health regeneration, recommended for first time players."
    }
